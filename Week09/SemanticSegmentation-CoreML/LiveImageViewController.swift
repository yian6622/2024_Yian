...
//    DeepLabV3Int8LUT : 177 517 1
    ...
    // MARK: - Shader Control
    @IBAction func applyStandardShader(_ sender: UIButton) {
        drawingView.currentShader = .standard
    }

    @IBAction func applyShaderDay70(_ sender: UIButton) {
        drawingView.currentShader = .day70
    }

    @IBAction func applyCustomShader(_ sender: UIButton) {
        drawingView.currentShader = .ex002  // Assuming this is the "custom" shader
    }
